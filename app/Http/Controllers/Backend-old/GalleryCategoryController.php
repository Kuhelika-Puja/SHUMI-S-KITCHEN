...
class GalleryCategoryController extends Controller
{
    ...
    {
        $data = [];
        $data['gallery_category'] = GalleryCategory::orderBy('id','desc')->get();;
        return view('backend.gallery.category.list',$data);
    }
    ...
    {
        return view('backend.gallery.category.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.gallery.category.edit',$data);
