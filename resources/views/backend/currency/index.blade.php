                    ...
                    <div class="card">
                        <div class="card-body">
                          @include('backend.partials._message')
                            <a href="{{route('currency.create')}}" class="btn btn-success">Create a new Currency</a> <br> <br>
                           ...
                           <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                               ...
                               <tbody>
                                ...
                                // print_r($news);
                                 ...
                                 if(isset($currencys) && !empty($currencys)){
                                ...
                                <?php $news1++; ?>
                                   <tr>
                                       ...
                                       <td>
                                         <a href="{{route('currency.edit',$data->id)}}" class="btn btn-info btn-sm">Edit</a>
                                         <form action="{{route('currency.destroy',$data->id)}}" method="post" style="display: inline-block;">
                                           @csrf
                                           @method('delete')
