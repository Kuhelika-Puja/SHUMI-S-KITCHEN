    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user-o"></i> <span>  About Owner </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li class="has_sub">
                ...
                <li class="has_sub">
                    <a href="{{route('publication.page')}}" class="waves-effect"><i class="zmdi zmdi-view-dashboard"></i><span> Publications </span> </a>
                </li>
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user-o"></i> <span> E-commerce </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
