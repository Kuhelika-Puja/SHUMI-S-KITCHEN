                    ...
                    <div class="card">
                        <div class="card-body">
                          @include('backend.partials._message')
                            <a href="{{ route('homepageimage.create') }}" class="btn btn-success">Create New Banner</a> <br> <br>
                               ...
                               <tbody>
                                ...
                                <?php $news1++; ?>
                                   <tr>
                                       ...
                                       <td>{{$data->position}}</td>
                                       <td>
                                         <a href="{{ route('homepageimage.edit', $data->id) }}" class="btn btn-info btn-sm">Edit</a>
                                         <form action="{{ route('homepageimage.destroy', $data->id) }}" method="post" style="display: inline-block;">
                                           @csrf
                                           @method('delete')
