                    ...
                    <div class="card">
                        <div class="card-body">
                          @include('backend.partials._message')
                            <a href="{{route('servicecharge.create')}}" class="btn btn-success">Create a new Service Charge</a> <br> <br>
                           ...
                           <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                               ...
                               <tbody>
                                ...
                                ?>
                                @foreach($service_charge as $data)
                                <?php $news1++; ?>
                                   <tr>
                                       <td>{{$news1}}</td>
                                       <td>{{$data->name}}</td>
                                       ...
                                       <td>
                                         <a href="{{route('servicecharge.edit',$data->id)}}" class="btn btn-info btn-sm">Edit</a>
                                         <form action="{{route('servicecharge.destroy',$data->id)}}" method="post" style="display: inline-block;">
                                           @csrf
                                           @method('delete')
