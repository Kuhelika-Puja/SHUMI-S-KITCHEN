...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="{{url('frontend/megamenuimage.png')}}" />
    ...
    <link rel="icon" href="{{url('frontend/logo/logo.png')}}" sizes="16x16" type="image/png">
    <title>Rene BD @yield('page-title')</title>
    <!-- Bootstrap CSS -->
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-4" id="stickyMenu">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto mx-auto">
              ...
              <li class="nav-item">
                <a class="nav-link custom-nav-link" href="{{url('/blog')}}">Making An Impact</a>
              </li>
              <li class="nav-item">
                <a class="nav-link custom-nav-link" href="{{ url('/our-clients') }}">Our Clients</a>
              </li>
              <li class="nav-item">
        ...
        <div class="row justify-content-center">
          <div class="col-md-12">
            ...
            <div class="social-icon text-center">
              <a href="https://www.facebook.com/renebd2015">
                <i class="fab fa-facebook facebook"></i>
              </a>
              <a href="https://instagram.com/rene_bangladesh?igshid=ifgk3z3jm24j">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="nav-link custom-nav-link" href="{{url('/instagram')}}">INSTAGRAM</a>
    ...
    <div class="footer-bottom">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <div class="mp-0">Copyright By Renebd</div>
          </div>
          <div class="col-md-6">
