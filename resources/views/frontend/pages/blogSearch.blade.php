    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control custom-form-control" placeholder="Search" aria-label="Recipient's username" aria-describedby="button-addon2" name="name" value="{{$name}}">
